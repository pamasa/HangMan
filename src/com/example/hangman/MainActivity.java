...
public class MainActivity extends Activity
{
   ...
   public static final String LETTERS = "pref_numberOfLetters";
   ...
   protected void onStart()
   {
      ...
      if (preferencesChanged) 
      {
         ...
         // initialize HangManFragment and start the game
         HangManFragment hangmanFragment = (HangManFragment)
            getFragmentManager().findFragmentById(R.id.hangManFragment);
         hangmanFragment.updateLetterAmount(
            PreferenceManager.getDefaultSharedPreferences(this));
         hangmanFragment.playGame();
      ...
      new OnSharedPreferenceChangeListener()
   {
         ...
         SharedPreferences sharedPreferences, String key)
      {
         ...
         if (key.equals(LETTERS)) // # of choices to display changed   
         {   
            hangmanFragment.updateLetterAmount(sharedPreferences);
            hangmanFragment.playGame();
         }
         
         Toast.makeText(MainActivity.this, 
            R.string.restarting_hangman, Toast.LENGTH_SHORT).show();
